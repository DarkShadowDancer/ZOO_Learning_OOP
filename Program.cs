    ...
    class ZOO
    {
        ...
        public void ModifyAnimals()
        {
            if (this.Animals.Count > 0)
            {
                ...
                Console.WriteLine("Do you want to change the current age of the animal? ({0}) 'Y/N'", this.Animals[indexUpravit].Age);
                if (Console.ReadLine().ToLower() == "y")
                {
                    int newAge;
                    for (; ; )
                    {
                        ...
                        Console.WriteLine("You entered an incorrect format for age. Please enter a number.");
                    }
                    this.Animals[indexUpravit].Age = newAge;
                }
                Console.WriteLine("Do you want to change the current wieght of the animal? ({0}) 'Y/N'", this.Animals[indexUpravit].Weight);
                if (Console.ReadLine().ToLower() == "y")
                {
                    double newWeight;
                    for (; ; )
                    {
                        ...
                        Console.WriteLine("You entered an incorrect format for weight. Please enter a number.");
                    }
        ...
        public void FindAnimals()
        {
            if (this.Animals.Count > 0)
            {
                ...
                if (checker == 0)
                {
                    Console.WriteLine("In the records, we don't have any animals with this name.");
                    return;
                }
            }
            else
        ...
        public void AddEmployee()
        {
            ...
            for (; ; )
            {
                ...
                Console.WriteLine("You entered the wrong format for the date of birth. Please enter a valid format.");
            }
            ...
            for (; ; )
            {
                ...
                Console.WriteLine("You entered the wrong format for the wage. Please enter a valid format.");
            }
            Employee employee = new Employee(firstName, surname, dateOfBirth, workPosition, wage);
        ...
        public void RemoveEmployee()
        {
            ...
            {
                Console.WriteLine("{0}.{1} {2}", i + 1, this.Employees[i].Name, this.Employees[i].Surname);
            }
            Console.WriteLine("Which employee do you want to delete (enter the number): ");
            int indexSmazat;
            while (!int.TryParse(Console.ReadLine(), out indexSmazat))
            {
                Console.WriteLine("Zadali ste neplatnu hodnotu. Prosim, zadajte platnu hodnotu.");
            }
            indexSmazat--;
            if (indexSmazat >= 0 && indexSmazat <= this.Employees.Count - 1)
            {
                Console.WriteLine("Vymazali ste zamestnanca {0} {1}.", this.Employees[indexSmazat].Name, this.Employees[indexSmazat].Surname);
        ...
        public void ListOfEmployees()
        {
            if (this.Employees.Count > 0)
            {
                ...
                using (List<Employee>.Enumerator enumerator = this.Employees.GetEnumerator())
                {
                    while (enumerator.MoveNext())
                    {
        ...
        public void ModifyEmployee()
        {
            if (this.Employees.Count > 0)
            {
                ...
                Console.WriteLine("Which employee do you want to modify (enter the number): ");
                int indexUpravit;
                ...
                Console.WriteLine("Modifying employee {0} {1}", this.Employees[indexUpravit].Name, this.Employees[indexUpravit].Surname);
                Console.WriteLine("Do you want to change the current first name and last name of the employee? ({0} {1}) 'Y/N'", this.Employees[indexUpravit].Name, this.Employees[indexUpravit].Surname);
                if (Console.ReadLine().ToLower() == "y")
                {
                    Console.Write("New name: ");
                ...
                Console.WriteLine("Do you want to change the current date of birth of the employee? ({0}) 'Y/N'", this.Employees[indexUpravit].DateOfBirth.ToString("dd.MM.yyyy"));
                if (Console.ReadLine().ToLower() == "y")
                {
                    DateTime newDate;
                    for (; ; )
                    {
                        ...
                        Console.WriteLine("You entered the wrong format for the date. Please enter the correct format.");
                    }
                    this.Employees[indexUpravit].DateOfBirth = newDate;
                }
                Console.WriteLine("Do you want to change the current salary of the employee? ({0}) 'Y/N'", this.Employees[indexUpravit].Wage);
                if (Console.ReadLine().ToLower() == "y")
                {
                    decimal newWage;
                    for (; ; )
                    {
                        ...
                        Console.WriteLine("You entered the wrong format for the wage. Please enter the correct format.");
                    }
                    this.Employees[indexUpravit].Wage = newWage;
                }
                Console.WriteLine("Do you want to change the current work position of the employee? ({0}) 'Y/N'", this.Employees[indexUpravit].WorkPosition);
                if (Console.ReadLine().ToLower() == "y")
                {
